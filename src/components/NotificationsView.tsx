      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900/50 rounded-2xl p-5 border border-gray-800">
            <div className="text-sm text-gray-400 mb-2">Notifications will be sent to</div>
          ...
          <div className="space-y-4">
            {/* Weekly Reports */}
            <div className="bg-gray-900/50 rounded-2xl p-5 border border-gray-800 hover:border-gray-700 transition-all">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h4 className="text-white font-semibold">Weekly Performance Reports</h4>
                  </div>
                  <p className="text-sm text-gray-400 ml-13 pl-13">
              ...
              {settings?.lastWeeklyReport && (
                <div className="mt-3 ml-13 text-xs text-gray-500 flex items-center gap-1">
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h4 className="text-white font-semibold">Goal Alerts</h4>
                  </div>
                ...
                >
                  <span 
                    className={`absolute top-1 left-1 w-6 h-6 bg-white rounded-full transition-transform shadow-md ${
                      settings?.goalAlerts ? 'translate-x-6' : 'translate-x-0'
                    }`}
                  />
                </button>
              </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900/50 rounded-2xl p-5 border border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h4 className="text-white font-semibold">Test Your Notifications</h4>
                <p className="text-sm text-gray-400">Send a test weekly report to verify your email settings.</p>
              </div>
            </div>
            <button
          ...
          <div className="bg-gray-900/50 rounded-2xl p-5 border border-gray-800">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-white font-semibold">How Notifications Work</h4>
            </div>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">Weekly reports are sent every <span className="text-blue-400 font-medium">Friday at 8:00 PM IST</span></span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">Goal alerts trigger when you close a trade that brings you closer to your target</span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">You can unsubscribe at any time by toggling the settings</span>
              </li>
            </ul>
          </div>

          {/* Schedule Info */}
          <div className="bg-gradient-to-br from-emerald-500/10 to-blue-500/10 rounded-2xl p-5 border border-emerald-500/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-emerald-400 font-semibold">Next Weekly Report</p>
                <p className="text-sm text-gray-400">Friday, 8:00 PM IST</p>
              </div>
            </div>
          </div>
        </div>
